...
def Master():
    ...
    skills_array3 = [[2, 2], [-4, 2], [4, 3], [1]]
    skills_array4 = [[0], [0], [0], [0]]
    while True:
        if count > 0:
...
def Elite_1ST(): #21-x(turn =
    ...
    skills_array17 = [[0], [4,3], [-101,0,4], [2,3]]
    skills_array18 = [[0], [4,3], [-101], [2,3]]
    skills_array19 = [[0], [1], [0], [14]]
    skills_array20 = [[0], [0], [0], [13,3]]
    wait_Battle()
    select_char_and_skill(characters_array, skills_array1)
    select_char_and_skill(characters_array, skills_array2)
    select_char_and_skill(characters_array, skills_array3)
...
def Elite_2ND():
    ...
    print("start")
    characters_array = [1, 2, 3, 4]
    skills_array1 = [[2,3], [4], [4,3], [-3,3]]
    skills_array2 = [[4], [-4], [-101], [-4]]
    skills_array3 = [[4], [-3,3], [-4], [4,1]]
    skills_array4 = [[0], [4], [5,3], [4,2]]
    skills_array5 = [[2,3], [-2,3], [-101,0,4], [12,3]]
    skills_array6 = [[4], [3,3], [4,3], [14]]
    skills_array7 = [[0], [-3,3], [-5,3], [0]]
    skills_array8 = [[0], [4], [-4,3], [101]]
    skills_array9 = [[101], [101], [-101], [13,2]]
    skills_array10 = [[2,3], [4], [101,0,4], [2,3]]
    skills_array11 = [[], [], [], []]
    skills_array12 = [[], [], [], []]
    skills_array13 = [[], [], [], []]
    skills_array14 = [[], [], [], []]
...
tap_After_checking(battle_icon_InTower, -1)
tap_After_checking(battle_icon_InTower_confirm, -1)
# double_fast_tap(1895, 958)
# double_fast_tap(1371, 812)
